...
{
    public static IDistributedApplicationTestingBuilder Create(DistributedApplicationOperation operation, string publisher = "manifest", string outputPath = "./", bool isDeploy = false, ITestOutputHelper? testOutputHelper = null)
    {
        ...
        {
            return Create(testOutputHelper, args);
        }
        else
        {
            return Create(args);
    ...
    public static IDistributedApplicationTestingBuilder CreateWithOutput(DistributedApplicationOperation operation, string publisher = "manifest",
        [CallerMemberName] string outputPath = "", ITestOutputHelper? testOutputHelper = null)
        => Create(operation, publisher, "./" + outputPath, false, testOutputHelper);
