...
[JsiiClass(typeof(DataAzapiResourceListRetryOutputReference), "azapi.dataAzapiResourceList.DataAzapiResourceListRetryOutputReference",
...
public class DataAzapiResourceListRetryOutputReference : ComplexObject
{
    /// <param name="terraformResource">The parent resource.</param>
    /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
    public DataAzapiResourceListRetryOutputReference(IInterpolatingParent terraformResource, string terraformAttribute) : base(_MakeDeputyProps(terraformResource,
        terraformAttribute))
    {
    }
    ...
    [JsiiOptional]
    [JsiiProperty("internalValue", "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azapi.dataAzapiResourceList.DataAzapiResourceListRetry\"}]}}", true)]
                ...
                switch (value)
                {
                    ...
                    default:
                        throw new ArgumentException(
                            $"Expected {nameof(value)} to be one of: {typeof(IResolvable).FullName}, {typeof(IDataAzapiResourceListRetry).FullName}; received {value.GetType().FullName}",
                            nameof(value));
                }
