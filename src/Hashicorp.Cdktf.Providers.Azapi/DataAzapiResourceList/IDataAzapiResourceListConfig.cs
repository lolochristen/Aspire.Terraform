...
namespace Hashicorp.Cdktf.Providers.Azapi.DataAzapiResourceList
{
    ...
    public interface IDataAzapiResourceListConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        IDataAzapiResourceListRetry? Retry
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        IDataAzapiResourceListTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, IDataAzapiResourceListConfig
        {
            ...
            {
                get => GetInstanceProperty<IDataAzapiResourceListRetry?>();
            }
            ...
            {
                get => GetInstanceProperty<IDataAzapiResourceListTimeouts?>();
            }
