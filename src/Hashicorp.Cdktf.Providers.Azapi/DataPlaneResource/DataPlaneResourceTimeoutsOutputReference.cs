...
[JsiiClass(typeof(DataPlaneResourceTimeoutsOutputReference), "azapi.dataPlaneResource.DataPlaneResourceTimeoutsOutputReference",
...
public class DataPlaneResourceTimeoutsOutputReference : ComplexObject
{
    /// <param name="terraformResource">The parent resource.</param>
    /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
    public DataPlaneResourceTimeoutsOutputReference(IInterpolatingParent terraformResource, string terraformAttribute) : base(_MakeDeputyProps(terraformResource,
        terraformAttribute))
    {
    }
    ...
    [JsiiOptional]
    [JsiiProperty("internalValue", "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azapi.dataPlaneResource.DataPlaneResourceTimeouts\"}]}}", true)]
                ...
                switch (value)
                {
                    ...
                    default:
                        throw new ArgumentException(
                            $"Expected {nameof(value)} to be one of: {typeof(IResolvable).FullName}, {typeof(IDataPlaneResourceTimeouts).FullName}; received {value.GetType().FullName}",
                            nameof(value));
                }
