...
namespace Hashicorp.Cdktf.Providers.Azapi.DataPlaneResource
{
    ...
    public interface IDataPlaneResourceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        IDataPlaneResourceTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, IDataPlaneResourceConfig
        {
            ...
            {
                get => GetInstanceProperty<IDataPlaneResourceRetry?>();
            }
            ...
            {
                get => GetInstanceProperty<IDataPlaneResourceTimeouts?>();
            }
