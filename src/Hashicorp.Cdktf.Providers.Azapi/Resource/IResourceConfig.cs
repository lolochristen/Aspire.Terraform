...
namespace Hashicorp.Cdktf.Providers.Azapi.Resource
{
    ...
    public interface IResourceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        internal sealed class _Proxy : DeputyBase, IResourceConfig
        {
            ...
            {
                get => GetInstanceProperty<IResourceRetry?>();
            }
            ...
            {
                get => GetInstanceProperty<IResourceTimeouts?>();
            }
