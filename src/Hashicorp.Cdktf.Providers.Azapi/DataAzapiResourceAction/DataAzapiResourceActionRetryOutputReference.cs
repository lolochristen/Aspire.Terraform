...
[JsiiClass(typeof(DataAzapiResourceActionRetryOutputReference), "azapi.dataAzapiResourceAction.DataAzapiResourceActionRetryOutputReference",
...
public class DataAzapiResourceActionRetryOutputReference : ComplexObject
{
    /// <param name="terraformResource">The parent resource.</param>
    /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
    public DataAzapiResourceActionRetryOutputReference(IInterpolatingParent terraformResource, string terraformAttribute) : base(_MakeDeputyProps(terraformResource,
        terraformAttribute))
    {
    }
    ...
    [JsiiOptional]
    [JsiiProperty("internalValue", "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azapi.dataAzapiResourceAction.DataAzapiResourceActionRetry\"}]}}", true)]
                ...
                switch (value)
                {
                    ...
                    default:
                        throw new ArgumentException(
                            $"Expected {nameof(value)} to be one of: {typeof(IResolvable).FullName}, {typeof(IDataAzapiResourceActionRetry).FullName}; received {value.GetType().FullName}",
                            nameof(value));
                }
