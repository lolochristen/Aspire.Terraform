...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/azure/azapi/2.4.0/docs/data-sources/resource azapi_resource}.</summary>
    [JsiiClass(nativeType: typeof(DataAzapiResource), fullyQualifiedName: "azapi.dataAzapiResource.DataAzapiResource", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"azapi.dataAzapiResource.DataAzapiResourceConfig\"}}]")]
    public class DataAzapiResource : HashiCorp.Cdktf.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/azure/azapi/2.4.0/docs/data-sources/resource azapi_resource} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataAzapiResource(Constructs.Construct scope, string id, IDataAzapiResourceConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, IDataAzapiResourceConfig config)
        {
        ...
        {
            return InvokeStaticMethod<HashiCorp.Cdktf.ImportableResource>(typeof(DataAzapiResource), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(HashiCorp.Cdktf.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(IDataAzapiResourceRetry)}, new object[]{@value});
        }
        ...
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(IDataAzapiResourceTimeouts)}, new object[]{@value});
        }
        ...
        public virtual DataAzapiResourceIdentityList Identity
        {
            get => GetInstanceProperty<DataAzapiResourceIdentityList>()!;
        }
        ...
        public virtual DataAzapiResourceRetryOutputReference Retry
        {
            get => GetInstanceProperty<DataAzapiResourceRetryOutputReference>()!;
        }
        ...
        public virtual DataAzapiResourceTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<DataAzapiResourceTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "retryInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azapi.dataAzapiResource.DataAzapiResourceRetry\"}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azapi.dataAzapiResource.DataAzapiResourceTimeouts\"}]}}", isOptional: true)]
