...
{
    [JsiiInterface(nativeType: typeof(IDataAzapiResourceConfig), fullyQualifiedName: "azapi.dataAzapiResource.DataAzapiResourceConfig")]
    public interface IDataAzapiResourceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        IDataAzapiResourceTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAzapiResourceConfig), fullyQualifiedName: "azapi.dataAzapiResource.DataAzapiResourceConfig")]
        internal sealed class _Proxy : DeputyBase, IDataAzapiResourceConfig
        {
            ...
            {
                get => GetInstanceProperty<IDataAzapiResourceRetry?>();
            }
            ...
            {
                get => GetInstanceProperty<IDataAzapiResourceTimeouts?>();
            }
