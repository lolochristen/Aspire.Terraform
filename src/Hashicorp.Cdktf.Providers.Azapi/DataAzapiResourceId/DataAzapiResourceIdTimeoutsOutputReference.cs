...
[JsiiClass(typeof(DataAzapiResourceIdTimeoutsOutputReference), "azapi.dataAzapiResourceId.DataAzapiResourceIdTimeoutsOutputReference",
...
public class DataAzapiResourceIdTimeoutsOutputReference : ComplexObject
{
    /// <param name="terraformResource">The parent resource.</param>
    /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
    public DataAzapiResourceIdTimeoutsOutputReference(IInterpolatingParent terraformResource, string terraformAttribute) : base(_MakeDeputyProps(terraformResource,
        terraformAttribute))
    {
    }
    ...
    [JsiiOptional]
    [JsiiProperty("internalValue", "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azapi.dataAzapiResourceId.DataAzapiResourceIdTimeouts\"}]}}", true)]
                ...
                switch (value)
                {
                    ...
                    default:
                        throw new ArgumentException(
                            $"Expected {nameof(value)} to be one of: {typeof(IResolvable).FullName}, {typeof(IDataAzapiResourceIdTimeouts).FullName}; received {value.GetType().FullName}",
                            nameof(value));
                }
