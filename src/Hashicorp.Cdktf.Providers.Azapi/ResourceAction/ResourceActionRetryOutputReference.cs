...
[JsiiClass(typeof(ResourceActionRetryOutputReference), "azapi.resourceAction.ResourceActionRetryOutputReference",
...
public class ResourceActionRetryOutputReference : ComplexObject
{
    /// <param name="terraformResource">The parent resource.</param>
    /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
    public ResourceActionRetryOutputReference(IInterpolatingParent terraformResource, string terraformAttribute) : base(_MakeDeputyProps(terraformResource, terraformAttribute))
    {
    }
    ...
    [JsiiOptional]
    [JsiiProperty("internalValue", "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"fqn\":\"azapi.resourceAction.ResourceActionRetry\"}]}}", true)]
                ...
                switch (value)
                {
                    ...
                    default:
                        throw new ArgumentException(
                            $"Expected {nameof(value)} to be one of: {typeof(IResolvable).FullName}, {typeof(IResourceActionRetry).FullName}; received {value.GetType().FullName}",
                            nameof(value));
                }
