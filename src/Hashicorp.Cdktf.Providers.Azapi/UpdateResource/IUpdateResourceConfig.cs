...
namespace Hashicorp.Cdktf.Providers.Azapi.UpdateResource
{
    ...
    public interface IUpdateResourceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        IUpdateResourceTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, IUpdateResourceConfig
        {
            ...
            {
                get => GetInstanceProperty<IUpdateResourceRetry?>();
            }
            ...
            {
                get => GetInstanceProperty<IUpdateResourceTimeouts?>();
            }
